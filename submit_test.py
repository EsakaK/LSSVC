...
command = "python3 test.py " \
          ...
          "--model_path " \
          "/model/EsakaK/My_Model/LSSVCM/LSSVC/q1.pth.tar " \
          "/model/EsakaK/My_Model/LSSVCM/LSSVC/q2.pth.tar " \
          "/model/EsakaK/My_Model/LSSVCM/LSSVC/q3.pth.tar " \
          "/model/EsakaK/My_Model/LSSVCM/LSSVC/q4.pth.tar " \
